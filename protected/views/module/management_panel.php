	...
	<div class="panel-body modulemanagementui-list">
		<div class="col-sm-2">
			<ul class="nav nav-pills nav-stacked" data-flag="true">
  				...
  				<li data-toggle="panel" data-target="#workflowmanagement-panel-item" data-panel="#panel-workflow" data-link="<?php echo Yii::app()->createUrl('workflow/getpanel'); ?>"><a><?php echo Yii::t('Base', 'Workflows'); ?></a></li>
			</ul>
		</div> 
