	...
	<div class="table-list" data-link="<?php echo Yii::app()->createUrl('group/getlist'); ?>">
		<div class="navbar-right">
   		...
   		<div class="navbar-right" style="margin-right:20px;">
   			<input type="text" class="form-control tableitem-keyword" data-toggle="enter.trigger" data-target="#panel-group .table-list" data-event="refresh.bs.tablelist" placeholder="<?php echo Yii::t('Base', 'Search'); ?>">
   		</div>
