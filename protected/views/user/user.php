<div id="panel-user">
	<div class="table-list" data-link="<?php echo Yii::app()->createUrl('user/getuserlist'); ?>">
		<div class="navbar-right">
			...
			<button type="button" class="btn btn-default" data-toggle="trigger" data-target="#panel-user .table-list" data-event="refresh.bs.tablelist"><?php echo Yii::t('Base', 'Refresh List'); ?></button>
   		...
   		<table class="table navbar-right">
			<thead>
   				<tr>
